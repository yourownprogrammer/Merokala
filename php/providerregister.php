...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $checkEmail = $conn->prepare("SELECT id FROM providers WHERE email = ?");
...
<form action="../php/providerregister.php" method="POST">
...
<div class="row-two">
    ...
    <div class="field">
        <input type="text" name="last_name" class="input-field" placeholder="Middle & Last Name" required>
        <span class="error"></span>
    </div>
</div>
...
<button type="submit" class="signup-btn">Create Provider Account</button>

</form>

<div class="footer-links">
    Already a provider? <a href="providerlogin.php">Login</a>
</div>
...
const emailError = emailInput.parentElement.querySelector(".error");
...
emailInput.addEventListener("input", () => {
    ...
    if (!/^[A-Za-z][A-Za-z0-9]*@[A-Za-z]+(\.[A-Za-z]{2,})+$/.test(value)) {
    ...
    // debounce server check (prevents spam)
